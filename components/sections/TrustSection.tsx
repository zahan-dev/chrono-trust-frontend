...
export const TrustSection = () => {
  ...
  return (
    <section className="py-24 lg:py-32 bg-[#fafafa] relative overflow-hidden border-b border-slate-200" id="trust">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          >
            <div className="mb-10">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-medium text-primary leading-[1.1] tracking-tight mb-6">
            ...
            <div className="relative w-full aspect-video rounded-2xl overflow-hidden bg-slate-900 group cursor-pointer mt-auto border border-silver/20 shadow-[0_10px_40px_rgba(30,58,95,0.08)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-16 h-16 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 group-hover:bg-primary group-hover:border-primary transition-all duration-500">
                  <PlayCircle className="w-8 h-8 text-white ml-1" strokeWidth={1.5} />
                </div>
              </div>
            </div>
          </motion.div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div 
                  ...
                  className="bg-white rounded-2xl p-6 lg:p-8 border border-silver/20 shadow-[0_4px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_10px_40px_rgba(30,58,95,0.06)] hover:-translate-y-1 transition-all duration-500 group flex items-start gap-6 flex-1"
                >
                  <div className="shrink-0 w-14 h-14 rounded-full bg-[#fafafa] flex items-center justify-center border border-silver/30 group-hover:bg-primary transition-colors duration-500">
